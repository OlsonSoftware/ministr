...
export const INSTALL_COMMANDS: readonly CliCommand[] = [
  {
    ...
    label: 'macOS',
    shell: 'bash',
    command: 'curl -fsSL https://ministr.ai/install.sh | bash',
    copyText: 'curl -fsSL https://ministr.ai/install.sh | bash',
  ...
  },
  {
    ...
    label: 'Windows',
    shell: 'powershell',
    command: 'iwr -useb https://ministr.ai/install.ps1 | iex',
    copyText: 'iwr -useb https://ministr.ai/install.ps1 | iex',
