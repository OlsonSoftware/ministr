    ...
    <div className="space-y-4 max-w-3xl">
      ...
      <Card hover="lift" className="p-4 space-y-3">
        <div className="flex items-center justify-between">
          <span className="text-mono-mini font-medium uppercase tracking-[0.05em] text-text-dim">
            Token budget
          </span>
      ...
      <Card hover="lift" className="p-4 space-y-3">
        <div className="flex items-center justify-between">
          <span className="flex items-center gap-1.5 text-mono-mini font-medium uppercase tracking-[0.05em] text-text-dim">
