...
const variants = {
  ...
  default:
    ...
    "shadow-[1px_1px_0_0_var(--shadow-color)] " +
    "hover:bg-accent-hover hover:shadow-[2px_2px_0_0_var(--shadow-color)] " +
    "active:shadow-none",
  ghost:
  ...
  return (
    <button
      className={cn(
        ...
        "inline-flex items-center justify-center font-sans font-semibold cursor-pointer transition-none",
