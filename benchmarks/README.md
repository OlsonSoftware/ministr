...
Source data is `ministr-core/tests/token_baseline.rs` (existing) plus the real end-to-end token economics measured in `ministr-mcp/tests/token_economics_e2e.rs`.
