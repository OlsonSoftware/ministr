...
//! stored for fast traversal via the `iris_related` tool.
...
///
/// ```
/// use iris_core::extraction::relationships::{HeuristicRelationshipDetector, RelationshipDetector};
/// use iris_core::types::{Claim, ClaimId, SectionId};
///
