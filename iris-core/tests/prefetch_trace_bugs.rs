...
use iris_core::session::prefetch::{PrefetchEngine, TopicTracker};
...
///
/// In production the call site is in `trigger_prefetch` (iris-mcp and
/// iris-daemon) — verified manually because setting up the full MCP
