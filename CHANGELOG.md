...
What each release promises about compatibility is spelled out in
[docs/reference/stability.md](docs/reference/stability.md).

> **Versions below 1.0.0-beta.1 were development milestones, not published
> releases.** They were tagged during private development and never had
> downloadable artifacts; their tags were removed when the project opened up.
