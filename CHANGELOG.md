...
## [0.5.2](https://github.com/OlsonSoftware/ministr/releases/tag/v0.5.2) - 2026-05-18

### Fixed
- The desktop app now probes common user-level binary directories when GUI launch environments provide a reduced `PATH`, so Claude/Codex CLI detection works more reliably (notably under `launchd` on macOS).
