...
export function CommandPalette({
  ...
  const commands: Cmd[] = useMemo(() => {
    const base: Cmd[] = [
      ...
      },
      {
        ...
        icon: Terminal,
        run: async () => {
          await navigator.clipboard.writeText("~/.iris/irisd.sock");
        },
      },
    ];
  ...
  return (
    <div
      className="fixed inset-0 z-[1000] flex items-start justify-center bg-bg/70 backdrop-blur-sm pt-24 px-6 iris-fade-in"
      role="dialog"
      aria-modal="true"
