...
///
/// ```
/// use ministr_core::llms_txt::LlmsTxtContent;
///
...
///
/// ```
/// use ministr_core::llms_txt::LlmsTxt;
///
/// let txt = LlmsTxt {
...
///
/// ```
/// use ministr_core::llms_txt::parse_llms_txt;
///
...
///
/// ```no_run
/// # use ministr_core::web::HttpClient;
/// # use ministr_core::llms_txt::fetch_llms_txt;
