...
//! and a User-Agent header identifying ministr. Also includes URL normalization
...
impl Default for HttpClientConfig {
    fn default() -> Self {
        Self {
            timeout_secs: 30,
            retry_count: 2,
            user_agent: format!("ministr/{}", env!("CARGO_PKG_VERSION")),
        }
    }
}
...
///
/// ```
/// use ministr_core::web::normalize_url;
///
...
///
/// ```
/// use ministr_core::web::{normalize_url, resolve_url};
///
...
mod tests {
    ...
    fn client_default_config() {
        ...
        assert!(config.user_agent.starts_with("ministr/"));
    }
