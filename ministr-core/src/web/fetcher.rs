...
///
/// ```
/// use ministr_core::web::fetcher::FetchStrategy;
///
...
///
/// ```
/// use ministr_core::web::fetcher::{FetchResult, FetchStrategy};
///
...
///
/// ```
/// use ministr_core::web::fetcher::WebFetcherConfig;
///
...
impl WebFetcher {
    ...
    /// immediately searchable via `ministr_survey`.
    ///
    /// # Errors
    ///
    /// Returns [`WebError`] if fetching fails, or [`WebError::IngestionFailed`]
