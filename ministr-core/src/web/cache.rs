...
//!
//! Persists fetched web pages under `~/.ministr/web/<url-hash>/` with a metadata
...
///
/// ```
/// use ministr_core::web::cache::WebPageMeta;
///
...
///
/// ```no_run
/// use ministr_core::web::cache::WebCache;
/// use std::path::Path;
///
/// let cache = WebCache::new(Path::new("/tmp/ministr-test/web"));
/// ```
pub struct WebCache {
...
///
/// ```
/// use ministr_core::web::cache::url_hash;
///
