...
///
/// ```
/// use ministr_core::web::sitemap::SitemapEntry;
///
...
///
/// ```
/// use ministr_core::web::sitemap::SitemapConfig;
///
...
///
/// ```
/// use ministr_core::web::sitemap::parse_sitemap;
///
...
///
/// ```
/// use ministr_core::web::sitemap::{SitemapEntry, SitemapConfig, filter_entries};
///
/// let entries = vec![
...
///
/// ```
/// use ministr_core::web::sitemap::is_sitemap_url;
///
