//! Cross-session analytics for ministr-core.
//!
...
//! - Access frequency: incremented on each `ministr_read` call.
...
impl Analytics {
    ...
    ///
    /// Call this after each `ministr_read` to build up access statistics.
    ///
    /// # Errors
    ///
