...
///
/// ```
/// use ministr_core::parser::generate_section_id;
///
...
///
/// ```
/// use ministr_core::parser::generate_code_section_id;
///
/// let id = generate_code_section_id("src/config.rs", &["config"], "MinistrConfig");
/// assert_eq!(id, "src/config.rs#config::MinistrConfig");
///
