...
///
/// ```
/// use ministr_core::code::bridge::EndpointRole;
///
...
///
/// ```
/// use ministr_core::code::bridge::ConfidenceLevel;
///
...
///
/// ```
/// use ministr_core::code::bridge::{BridgeEndpoint, BridgeKind, EndpointRole};
///
...
///
/// ```
/// use ministr_core::code::bridge::{BridgeEndpoint, BridgeKind, BridgeLink, EndpointRole};
///
...
///
/// ```
/// use ministr_core::code::bridge::snake_to_camel;
///
...
///
/// ```
/// use ministr_core::code::bridge::camel_to_snake;
///
