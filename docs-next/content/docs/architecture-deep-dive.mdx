---
title: ministr-rs Architecture — The Deep Dive
...
After each `ministr_read`, the prefetch engine speculatively pre-warms sections the agent is likely to request next. Five strategies:
