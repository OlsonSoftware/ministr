//! Standalone helper functions used by the iris MCP server.
//!
...
use iris_core::service::QueryError;
...
pub(crate) const INGESTION_PROGRESS_TOKEN: &str = "iris/ingestion";
...
pub(crate) fn build_instructions(router: &ToolRouter<IrisServer>) -> String {
